...
namespace APIPeli.Endpoints
{
    public static class PeliculasEndPoints
    {
        ...
        static async Task<Results<Ok<PeliculaDTO>, NotFound>> ObtenerPorId(int id, 
            ...
            IRepositorioGeneros repositorioGeneros)
        {
            ...
            {
                var generosNoExistentes = generosIds.Except(generosExistentes); //con Except decimos que se traigan aquellos generosid que no se encuentren dentro de generosExistentes y que lo cargue en la variable. 
